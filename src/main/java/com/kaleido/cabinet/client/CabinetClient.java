...
public class CabinetClient<E> {
	...
	public ResponseEntity<String> save(@Valid E entity) {
        return (ResponseEntity<String>) retryTemplate.execute(arg0 -> {
            ...
            try {
                ...
                if (id == null) {
                    ...
                    return restTemplate.postForEntity(endpoint, plateEntity, String.class);
                } else {
                    //got an id, PUT it
    ...
    /**
     * Calling cabinet api to save plateMap
     *
     * @param URI  the URI link for cabinet
     * @param plateMap the plateMap value
